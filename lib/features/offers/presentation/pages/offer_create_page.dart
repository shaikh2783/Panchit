...
class OfferCreatePage extends StatefulWidget {
  ...
  @override
  State<OfferCreatePage> createState() => _OfferCreatePageState();
}
class _OfferCreatePageState extends State<OfferCreatePage> {
  ...
  Future<void> _submit() async {
    ...
    if (_descCtrl.text.trim().isEmpty) {
      Get.snackbar('error'.tr, 'Description is required');
      return;
    }
    ...
    try {
      ...
      await repo.createOffer(body);
      Get.back();
      Get.snackbar('success'.tr, 'offer_created_successfully'.tr);
    } catch (e) {
