...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _handleRefresh() async {
    ...
    await postsBloc.stream.firstWhere(
      (state) => state is! PostsLoadingState,
    );
  }
  void _openCreatePost() {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (_) => const CreatePostPageModern(),
    ));
  }
  ...
  Widget build(BuildContext context) {
    ...
    final displayName = auth.currentUser?['user_fullname'] ??
    ...
    return Scaffold(
        ...
        title: Row(
          children: [
            Container(
              ...
              child: Icon(Iconsax.flash, color: Colors.white, size: 22),
            ),
      ...
      body: BlocConsumer<PostsBloc, PostsState>(
        ...
        builder: (context, state) {
          ...
          final isLoadingMore = state is PostsLoadedState ? state.isLoadingMore : false;
          ...
          if (posts.isEmpty && state is PostsLoadedState) {
            return RefreshIndicator(
              ...
              child: CustomScrollView(
                ...
                slivers: [
                  SliverToBoxAdapter(
                    child: _ComposerCard(displayName: displayName, onTap: _openCreatePost),
                  ),
                  SliverFillRemaining(
...
class _StoriesRail extends StatelessWidget {
  ...
  void _openStories(BuildContext context, int index) {
    Navigator.of(context).push(MaterialPageRoute(
      builder: (_) => StoryViewerPage(stories: stories, initialStoryIndex: index),
    ));
  }
                ...
                if (firstItem != null)
                  Positioned.fill(
                    child: CachedNetworkImage(imageUrl: 
                      mediaAsset(firstItem.source).toString(),
                      fit: BoxFit.cover,
                    ),
                  ),
                Positioned.fill(
                  ...
                  child: CircleAvatar(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: story.authorAvatarUrl != null
                          ? CachedNetworkImageProvider(mediaAsset(story.authorAvatarUrl!).toString())
                          : null,
...
class _ComposerCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isDark = Get.isDarkMode || Theme.of(context).brightness == Brightness.dark;
    final cs = Theme.of(context).colorScheme;
    return Container(
