...
class _SavedPostsPageState extends State<SavedPostsPage> {
  ...
  Future<void> _loadSavedPosts() async {
    ...
    try {
      ...
      final response = await postsRepository.fetchSavedPosts(
        limit: _limit,
        offset: _offset,
      );
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return PostCard(
                        ...
                        onReactionChanged: (postId, reaction) {
                          // Optimistic local update of reaction state
                          ...
                          // Also dispatch to global PostsBloc via PostCard's internal logic
                        },
                        onPostUpdated: (updatedPost) {
                          // Keep local list in sync; remove if unsaved in Saved page
