...
import 'package:snginepro/features/monetization/data/models/monetization_payment.dart';
import 'package:snginepro/features/monetization/data/services/monetization_api_service.dart';
import '../../../../main.dart' show globalApiClient;

class MonetizationPaymentsPage extends StatefulWidget {
  const MonetizationPaymentsPage({Key? key}) : super(key: key);
...
class _MonetizationPaymentsPageState extends State<MonetizationPaymentsPage> {
  ...
  late Future<List<MonetizationPayment>> _paymentsFuture;
  ...
  Future<Map<String, dynamic>> _loadSettings() async {
    final response = await _apiService.getMonetizationSettings();
  ...
  Future<List<MonetizationPayment>> _loadPayments() async {
    final response = await _apiService.getPayments();
    if (response['success'] == true) {
      return response['payments'] as List<MonetizationPayment>;
    }
    return [];
  }
          ...
          children: [
            ...
            FutureBuilder<Map<String, dynamic>>(
              ...
              builder: (context, snapshot) {
                ...
                final balance =
                    0.0; // You can get balance from settings if available
            ...
            FutureBuilder<List<MonetizationPayment>>(
  ...
  Widget _buildPaymentCard(MonetizationPayment payment, int index) {
    return Padding(
