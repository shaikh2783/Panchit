...
class AlbumPhotosPage extends StatelessWidget {
  ...
  const AlbumPhotosPage({super.key, required this.album});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AlbumPhotosGrid(albumId: album.albumId, service: service),
    );
  }
}
...
class AlbumPhotosGrid extends StatefulWidget {
  ...
  const AlbumPhotosGrid({super.key, required this.albumId, required this.service});
    ...
    return Column(
      children: [
        Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.photo_album, size: 16, color: Theme.of(context).colorScheme.outline),
