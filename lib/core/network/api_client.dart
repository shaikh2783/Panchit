...
class ApiClient {
  ...
  Future<Map<String, dynamic>> post(
    ...
    if (requestBody != null) {
      ...
      final preview = encoded.length > 300 ? '${encoded.substring(0, 300)}...' : encoded;
    } else {
    }
  ...
  Future<Map<String, dynamic>> multipartPost(
    ...
    int sent = 0;
    final progressTransformer = StreamTransformer<List<int>, List<int>>.fromHandlers(
    ...
    final stream = http.ByteStream(file.openRead().transform(progressTransformer));
