...
// Wallet & Payment
  ...
  'wallet_current_balance_label': 'നിലവിലെ ബാലൻസ്',
  'wallet_refresh_balance': 'ബാലൻസ് പുതുക്കുക',
  'wallet_action_recharge': 'റീചാർജ്',
  'wallet_action_transfer': 'കൈമാറ്റം',
  'wallet_action_send_tip': 'ടിപ്പ് അയക്കുക',
  'wallet_action_withdraw': 'പിൻവലിക്കുക',
  'wallet_label_available': 'ലഭ്യം',
  'wallet_label_points': 'പോയിന്റുകൾ',
  'wallet_label_tips_today': 'ഇന്നത്തെ ടിപ്സ്',
  'wallet_payment_methods': 'പേമെന്റ് രീതികൾ: @methods',
  'wallet_balance_updated_at': 'അപ്‌ഡേറ്റ് @date',
...
// Orders Page
  ...
  "competition_payment_title": "മത്സര പ്രവേശന പേമെന്റ്",
  "competition_payment_review_msg": "മത്സര പോസ്റ്റ് അപ്‌ലോഡ് ചെയ്യുന്നതിന് മുമ്പ് വാലറ്റ് ഉപയോഗിച്ച് പ്രവേശന ഫീ പേമെന്റ് അവലോകനം ചെയ്യുക.",
  "competition_payment_low_balance_msg": "നിങ്ങളുടെ വാലറ്റ് ബാലൻസ് കുറവാണ്. ആദ്യം റീചാർജ് ചെയ്ത് അപ്‌ലോഡ് തുടരുക.",
  "competition_current_balance": "നിലവിലെ ബാലൻസ്",
  "competition_balance_after_payment": "പേമെന്റിന് ശേഷം ബാലൻസ്",
  "competition_balance_shortfall": "ബാലൻസ് കുറവ്",
  "competition_pay_from_wallet": "വാലറ്റ് ഉപയോഗിച്ച് പേ ചെയ്യുക",
  "competition_recharge_wallet": "വാലറ്റ് റീചാർജ് ചെയ്യുക",
  ...
  "live_category_general":"പൊതുവായത്",
  "live_category_gaming":"ഗെയിമിംഗ്",
  "live_category_education":"വിദ്യാഭ്യാസം",
  "live_category_sports":"കായികം",
  "live_category_cooking":"പാചകം",
  "live_category_music":"സംഗീതം",
  "live_category_tech":"സാങ്കേതികവിദ്യ",
  "live_category_art":"കല",
  "live_category_travel":"യാത്ര",

  "live_settings_title":"ലൈവ് സ്ട്രീം ക്രമീകരണങ്ങൾ",
  "live_settings_video_section":"വീഡിയോ ക്രമീകരണങ്ങൾ",
  "live_settings_recording_title":"സ്ട്രീം റെക്കോർഡ് ചെയ്യുക",
  "live_settings_recording_subtitle":"പിന്നീട് കാണാൻ സ്ട്രീം സേവ് ചെയ്യുക",
  "live_settings_privacy_section":"സ്വകാര്യതാ ക്രമീകരണങ്ങൾ",
  "live_settings_private_title":"സ്വകാര്യ സ്ട്രീം",
  "live_settings_private_subtitle":"ക്ഷണിക്കപ്പെട്ട കാഴ്ചക്കാർക്ക് മാത്രം പരിമിതം",
  "live_settings_subscribers_only_title":"സബ്‌സ്‌ക്രൈബർമാർക്ക് മാത്രം",
  "live_settings_subscribers_only_subtitle":"നിങ്ങളുടെ ചാനലിന്റെ സബ്‌സ്‌ക്രൈബർമാർക്ക് മാത്രം ലഭ്യമാണ്",
  "live_settings_interaction_section":"ഇന്ററാക്ഷൻ ക്രമീകരണങ്ങൾ",
  "live_settings_allow_comments_title":"കമന്റുകൾ അനുവദിക്കുക",
  "live_settings_allow_comments_subtitle":"കാഴ്ചക്കാർക്ക് കമന്റ് ചെയ്യാം",
  "live_settings_allow_reactions_title":"പ്രതികരണങ്ങൾ അനുവദിക്കുക",
  "live_settings_allow_reactions_subtitle":"ലൈക്ക്, ലവ്, ദേഷ്യം മുതലായവ",
  "live_settings_monetization_section":"വരുമാന ക്രമീകരണങ്ങൾ",
  "live_settings_enable_tips_title":"ടിപ്പുകൾ പ്രാപ്തമാക്കുക",
  "live_settings_enable_tips_subtitle":"കാഴ്ചക്കാർക്ക് പണ ടിപ്പുകൾ അയക്കാം",
  "live_settings_tips_info":"ടിപ്പുകൾ നിങ്ങളുടെ ഡിജിറ്റൽ വാലറ്റിൽ ലഭിക്കും. അക്കൗണ്ട് ക്രമീകരണങ്ങളിൽ നിന്ന് നിങ്ങൾക്ക് ഇവ എപ്പോൾ വേണമെങ്കിലും പിൻവലിക്കാം.",
  "live_settings_category_title":"സ്ട്രീം വിഭാഗം",
  "live_settings_advanced_section":"വിപുലമായ ക്രമീകരണങ്ങൾ",
  "live_settings_banned_users_title":"വിലക്കപ്പെട്ട ഉപയോക്താക്കളെ നിയന്ത്രിക്കുക",
  "live_settings_banned_users_subtitle":"സ്ട്രീമിൽ നിന്ന് വിലക്കപ്പെട്ട ഉപയോക്താക്കളുടെ പട്ടിക",
  "live_settings_stream_keys_title":"സ്ട്രീം കീകൾ",
  "live_settings_stream_keys_subtitle":"ബാഹ്യ സോഫ്റ്റ്‌വെയറിൽ നിന്ന് സ്ട്രീമിംഗ് സജ്ജീകരിക്കുക",
  "live_settings_detailed_stats_title":"വിശദമായ സ്ഥിതിവിവരക്കണക്കുകൾ",
  "live_settings_detailed_stats_subtitle":"മുൻകാല സ്ട്രീമുകളുടെ പ്രകടനം വിശകലനം ചെയ്യുക",
  "live_settings_quality_label":"സ്ട്രീം ഗുണനിലവാരം",
  "live_settings_saved_success":"ക്രമീകരണങ്ങൾ വിജയകരമായി സേവ് ചെയ്തു",
  "live_settings_feature_coming_message":"\"@feature\" ഫീച്ചർ വരാനിരിക്കുന്ന അപ്‌ഡേറ്റിൽ ലഭ്യമാകും.",

  "live_options_title":"ലൈവ് സ്ട്രീം",
  "live_options_hero_title":"ലൈവ് സ്ട്രീം ആരംഭിക്കുക",
  "live_options_hero_subtitle":"നിങ്ങളുടെ ഫോളോവേഴ്‌സുമായി തത്സമയം നിങ്ങളുടെ നിമിഷങ്ങൾ പങ്കിടുക",
  "live_options_quick_title":"ക്വിക്ക് സ്ട്രീം",
  "live_options_quick_subtitle":"ഡിഫോൾട്ട് ക്രമീകരണങ്ങളോടെ ഉടൻ സ്ട്രീമിംഗ് ആരംഭിക്കുക",
  "live_options_advanced_title":"വിപുലമായ ക്രമീകരണങ്ങൾ",
  "live_options_advanced_subtitle":"സ്ട്രീം ഗുണനിലവാരവും ക്രമീകരണങ്ങളും ഇഷ്ടാനുസൃതമാക്കുക",
  "live_options_schedule_title":"സ്ട്രീം ഷെഡ്യൂൾ ചെയ്യുക",
  "live_options_schedule_subtitle":"ഭാവിയിലെ സ്ട്രീമിനായി ഒരു തീയതി നിശ്ചയിക്കുക",
  "live_options_connection_tip":"മികച്ച സ്ട്രീമിംഗ് ഗുണനിലവാരത്തിന് ശക്തമായ ഇന്റർനെറ്റ് കണക്ഷൻ ഉറപ്പാക്കുക",
  "live_options_schedule_coming_message":"സ്ട്രീം ഷെഡ്യൂളിംഗ് ഫീച്ചർ വരാനിരിക്കുന്ന അപ്‌ഡേറ്റിൽ ലഭ്യമാകും.",

  "live_controls_camera_off":"ക്യാമറ ഓഫ് ചെയ്യുക",
  "live_controls_camera_on":"ക്യാമറ ഓൺ ചെയ്യുക",
  "live_controls_mic_off":"മൈക്ക് ഓഫ് ചെയ്യുക",
  "live_controls_mic_on":"മൈക്ക് ഓൺ ചെയ്യുക",
  "live_controls_switch_camera":"ക്യാമറ മാറ്റുക",
  "live_controls_end_stream":"സ്ട്രീം അവസാനിപ്പിക്കുക",

  "live_comments_header":"ലൈവ് കമന്റുകൾ",
  "live_comments_empty":"ഇതുവരെ കമന്റുകളൊന്നുമില്ല\nകമന്റ് ചെയ്യുന്ന ആദ്യ വ്യക്തിയാകൂ!",
  "live_comments_start_watching":"ലൈവ് കമന്റുകൾ കാണാൻ ആരംഭിക്കുക",
  "live_comments_hint":"ഒരു കമന്റ് ചേർക്കുക...",

  "live_comments_error_loading":"കമന്റുകൾ ലോഡ് ചെയ്യുന്നതിൽ പിശക്",
  "live_comments_error_loading_detail":"കമന്റുകൾ ലോഡ് ചെയ്യുന്നതിൽ പിശക്: @error",
  "live_comments_error_adding":"കമന്റ് ചേർക്കുന്നതിൽ പിശക്",
  "live_comments_error_adding_detail":"കമന്റ് ചേർക്കുന്നതിൽ പിശക്: @error",
  "live_comments_error_reacting":"കമന്റിനോട് പ്രതികരിക്കുന്നതിൽ പിശക്",
  "live_comments_error_reacting_detail":"പ്രതികരിക്കുന്നതിൽ പിശക്: @error",
  "live_stats_error_loading":"സ്ഥിതിവിവരക്കണക്കുകൾ ലോഡ് ചെയ്യുന്നതിൽ പിശക്",
  "live_stats_error_loading_detail":"സ്ഥിതിവിവരക്കണക്കുകൾ ലോഡ് ചെയ്യുന്നതിൽ പിശക്: @error",

  "live_api_error_create_stream":"സ്ട്രീം സൃഷ്ടിക്കുന്നതിൽ പരാജയപ്പെട്ടു: @message",
  "live_api_error_create_stream_generic":"ലൈവ് സ്ട്രീം സൃഷ്ടിക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_fetch_comments":"കമന്റുകൾ ലഭ്യമാക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_add_comment":"കമന്റ് ചേർക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_react_comment":"കമന്റിനോട് പ്രതികരിക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_delete_comment":"കമന്റ് ഇല്ലാതാക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_edit_comment":"കമന്റ് എഡിറ്റ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_send_reaction":"പ്രതികരണം അയക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_start_stream":"ലൈവ് സ്ട്രീം ആരംഭിക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_end_stream":"ലൈവ് സ്ട്രീം അവസാനിപ്പിക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_fetch_list":"സ്ട്രീം ലിസ്റ്റ് ലഭ്യമാക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_trial_join_maintenance":"ട്രയൽ ജോയിൻ - ബാക്കെൻഡ് അറ്റകുറ്റപ്പണിയിലാണ്",
  "live_api_all_endpoints_failed":"എല്ലാ എൻഡ്‌പോയിന്റുകളും പരാജയപ്പെട്ടു",
  "live_api_trial_join_error_ignored":"ട്രയൽ ജോയിൻ (ബാക്കെൻഡ് പിശക് അവഗണിച്ചു)",
  "live_api_error_join_stream":"സ്ട്രീമിൽ ചേരുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_left_locally":"പ്രാദേശികമായി വിട്ടു",
  "live_api_error_fetch_updates":"അപ്‌ഡേറ്റുകൾ ലഭ്യമാക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_upload_file":"ഫയൽ അപ്‌ലോഡ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_agora_token":"Agora ടോക്കൺ ലഭ്യമാക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_fetch_active":"സജീവ സ്ട്രീമുകൾ ലഭ്യമാക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error",
  "live_api_error_fetch_posts":"ലൈവ് സ്ട്രീം പോസ്റ്റുകൾ ലഭ്യമാക്കുന്നതിൽ പരാജയപ്പെട്ടു: @error"
